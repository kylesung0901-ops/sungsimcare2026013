        ...
        <main>
            ...
            <div className={styles.banner}>
                <div className="container">
                    <h2 className="text-uppercase text-bold color-white">따뜻한 동행</h2>
                    <p className="color-white">Story of Warm Companion</p>
                </div>
            </div>
                ...
                <div className="container">
                    <div className={styles.contentGrid}>
                        ...
                        <div className={styles.imageContent}>
                            <img src="https://images.unsplash.com/photo-1581578731522-745bf05499dd?auto=format&fit=crop&w=800&q=80" alt="Companion" />
                        </div>
                    </div>
                </div>
            </section>
